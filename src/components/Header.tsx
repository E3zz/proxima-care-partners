    ...
    >
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8 flex items-center justify-between h-20">
        ...
        <Link to="/" className="flex items-center gap-3 group">
          ...
          <div>
            <span className="text-white font-bold text-lg leading-none tracking-tight" style={{ fontFamily: 'Manrope, sans-serif' }}>
              Proxima Care
            </span>
            <div className="text-teal-400 text-xs font-semibold tracking-widest uppercase">Partners</div>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-3">
          <Link
            to="/contact"
            className="hidden lg:flex items-center gap-2 border border-white/10 bg-white/5 px-5 py-2 text-sm font-semibold text-slate-300 hover:bg-white/10 hover:border-teal-500/40 hover:text-teal-300 transition-all duration-200 rounded-sm"
          >
          ...
          <Link
            to="/contact"
            className="bg-teal-600 text-white px-6 py-2.5 text-sm font-bold hover:bg-teal-500 active:scale-95 transition-all duration-200 shadow-lg shadow-teal-900/50 rounded-sm"
          >
            Contact Us
          </Link>
          {/* Mobile hamburger */}
      ...
      >
        <nav className="px-6 py-4 flex flex-col gap-4" aria-label="Mobile navigation">
          ...
          <div className="flex flex-col gap-3 pt-4 border-t border-white/8">
            ...
            <Link
              to="/contact"
              className="flex-1 bg-teal-600 text-white py-2 text-sm font-bold text-center rounded-sm hover:bg-teal-500 transition-colors"
              onClick={() => setMobileOpen(false)}
            >
              Contact Us
            </Link>
